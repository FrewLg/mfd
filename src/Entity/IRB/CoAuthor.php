...
use App\Entity\User;
use App\Repository\IRB\CoAuthorRepository;
...
class CoAuthor
{
 ...
 /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Application::class, inversedBy="memebers")
    ...
    public function setMidleName(?string $middle_name): self
    {
