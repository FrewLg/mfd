...
//Uewt3bOKzulDmLrv
  ...
  public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
  {
    ...
    if (   in_array("vprcs", $roles)) { 
      return new RedirectResponse($this->urlGenerator->generate('vprs_calls'));
    }

 
    if (   in_array("coordinators", $roles)) { 
      return new RedirectResponse($this->urlGenerator->generate('coll_coordinators'));
    }
